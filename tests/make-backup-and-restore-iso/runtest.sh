...
POST_RECOVERY_SCRIPT=(\"ls -l /mnt/local/var /mnt/local/var/ARTIFACTS > /dev/console 2>&1;\" \"tail /var/lib/rear/restore/recover.backup.*.restore.log > /dev/ttyS0 2>&1;\" \"sleep 900;\")
